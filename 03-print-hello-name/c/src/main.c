...
static char doc[] = "Command Line Interface Hello Name";
...
static struct argp_option options[] = {
    {0, 0, 0, 0, "Options:"},
    {"repeat", 'r', "TIMES", 0, "Repeat execution 'Hello Name!' times. Default repeat=100", 1},
...
static error_t parse_opt(int key, char *arg, struct argp_state *state)
{
     ...
     *  Var Infor App
     */
    const char *program_version = "Hello Name 1.0.0";
 ...
 *                    Showhelloloop
 ***************************************************************************/
static inline void showhelloloop(int maxLoop, char *name)
{
...
int main(int argc, char *argv[])
{
    ...
    showhelloloop(arguments.repeat, arguments.args[0]);
